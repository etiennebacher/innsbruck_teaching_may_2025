...
* Hands-on practice: IPUMS census data (samples)
  - Install and load polars, load data, perform easy operations, export data
  - Using expressions
...
* [Polars official documentation (Python)](https://docs.pola.rs/)
...
There exists other tools:

* DuckDB: 
  - very fast and efficient too, uses SQL syntax
  - available in R too
  - accompanying package [`duckplyr`](https://duckplyr.tidyverse.org/) (same goal as `tidypolars` but uses DuckDB in the background)
  
* Arrow: also has lazy evaluation but less optimizations that Polars and DuckDB.
