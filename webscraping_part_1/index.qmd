...
# Hands-on case study: electoral results in Spain
...
Now we have the table for one municipality: how can we generalize that?
...
To generalize the code, we need to have to loop through all of those combinations:
...
Slides and code: [https://github.com/etiennebacher/innsbruck_teaching_may_2025](https://github.com/etiennebacher/innsbruck_teaching_may_2025) (not available yet).
